...
test("activity form sheet geometry follows the prototype measurements", () => {
  ...
  assert.match(css, /\.activity-sheet-header\s*{[^}]*height:\s*80rpx;[^}]*margin-top:\s*12rpx;[^}]*padding:\s*0 36rpx;/s);
  ...
  assert.match(css, /\.activity-sheet-footer\s*{[^}]*position:\s*absolute;[^}]*bottom:\s*0;[^}]*height:\s*calc\(100rpx \+ env\(safe-area-inset-bottom\)\);/s);
  assert.match(css, /\.bento-grid\s*{[^}]*padding:\s*12rpx 36rpx 16rpx;/s);
  assert.match(css, /\.activity-sheet-close-icon\s*{[^}]*width:\s*40rpx;[^}]*height:\s*40rpx;/s);
  assert.match(css, /\.compact-card\s*{[^}]*height:\s*92rpx;[^}]*padding:\s*16rpx 24rpx;/s);
  assert.match(css, /\.compact-switch-card\s*{[^}]*height:\s*92rpx;/s);
  assert.match(css, /\.prototype-switch\s*{[^}]*width:\s*92rpx;[^}]*height:\s*56rpx;[^}]*padding:\s*6rpx;/s);
  assert.match(css, /\.prototype-switch-thumb\s*{[^}]*width:\s*44rpx;[^}]*height:\s*44rpx;/s);
  assert.match(css, /\.stepper\s*{[^}]*width:\s*220rpx;[^}]*height:\s*76rpx;[^}]*justify-content:\s*space-between;[^}]*padding:\s*0 20rpx;/s);
  assert.match(css, /\.stepper-icon\s*{[^}]*width:\s*40rpx;[^}]*height:\s*40rpx;/s);
  assert.match(css, /\.stepper-value\s*{[^}]*width:\s*44rpx;[^}]*font-size:\s*28rpx;[^}]*line-height:\s*1;[^}]*font-weight:\s*700;/s);
  ...
  assert.match(css, /\.activity-time-card,[\s\S]*?\.deadline-card\s*\{[^}]*gap:\s*16rpx;[^}]*padding:\s*16rpx 24rpx;/s);
  assert.match(css, /\.date-time-row\s*\{[^}]*gap:\s*16rpx;/s);
  assert.match(css, /\.prototype-switch\s*\{[^}]*border-radius:\s*28rpx;/s);
  ...
  assert.match(css, /\.sheet-button\s*\{[^}]*border-radius:\s*24rpx;/s);
  ...
  assert.match(css, /\.activity-sheet-panel--create\s*{[^}]*padding-bottom:\s*calc\(112rpx \+ env\(safe-area-inset-bottom\)\);/s);
  ...
  assert.match(css, /\.bento-grid--create\s*{[^}]*gap:\s*12rpx;/s);
  assert.match(css, /\.activity-sheet-panel--create \.compact-card,[\s\S]*?height:\s*104rpx;/s);
  assert.match(css, /\.activity-sheet-panel--create \.compact-select-row\s*\{[^}]*gap:\s*16rpx;/s);
  assert.match(css, /\.activity-sheet-panel--create \.stepper-card\s*\{[^}]*min-height:\s*104rpx;/s);
  assert.match(css, /\.activity-sheet-panel--create \.stepper\s*\{[^}]*width:\s*220rpx;[^}]*height:\s*72rpx;[^}]*padding:\s*0 24rpx;[^}]*gap:\s*24rpx;/s);
  assert.match(css, /\.activity-sheet-panel--create \.stepper-button\s*\{[^}]*width:\s*40rpx;[^}]*height:\s*40rpx;/s);
  assert.match(css, /\.stepper-value-input\s*\{[^}]*width:\s*44rpx;[^}]*height:\s*40rpx;[^}]*font-size:\s*28rpx;[^}]*font-weight:\s*700;[^}]*text-align:\s*center;/s);
  ...
  assert.match(css, /\.activity-sheet-panel--create \.participant-limit-card--create\.participant-limit-card--visible\s*\{[^}]*min-height:\s*104rpx;[^}]*height:\s*104rpx;[^}]*opacity:\s*1;[^}]*pointer-events:\s*auto;/s);
  ...
  assert.match(css, /\.activity-sheet-footer--create\s*{[^}]*height:\s*calc\(112rpx \+ env\(safe-area-inset-bottom\)\);[^}]*border-top-width:\s*2rpx;/s);
  assert.match(css, /\.activity-sheet-footer-actions--create\s*{[^}]*height:\s*112rpx;[^}]*padding:\s*12rpx 32rpx;/s);
  assert.match(css, /\.sheet-button--primary-create\s*{[^}]*box-shadow:\s*0 4rpx 16rpx rgba\(0, 0, 0, 0\.05\);/s);
  assert.match(css, /\.activity-sheet-panel--edit\s*{[^}]*padding-bottom:\s*calc\(112rpx \+ env\(safe-area-inset-bottom\)\);/s);
  ...
  assert.match(css, /\.bento-grid--edit\s*{[^}]*gap:\s*12rpx;/s);
  assert.match(css, /\.activity-sheet-panel--edit \.compact-card,[\s\S]*?height:\s*104rpx;/s);
  ...
  assert.match(css, /\.activity-sheet-panel--edit \.participant-limit-card--edit\.participant-limit-card--visible\s*{[^}]*min-height:\s*104rpx;[^}]*height:\s*104rpx;[^}]*opacity:\s*1;[^}]*pointer-events:\s*auto;/s);
  ...
  assert.match(css, /\.activity-sheet-footer--double\s*{[^}]*height:\s*calc\(112rpx \+ env\(safe-area-inset-bottom\)\);[^}]*border-top-width:\s*2rpx;/s);
  assert.match(css, /\.activity-sheet-footer-actions--edit\s*{[^}]*height:\s*112rpx;[^}]*padding:\s*12rpx 32rpx;[^}]*gap:\s*16rpx;/s);
  assert.match(css, /\.sheet-button--secondary-edit\s*{[^}]*width:\s*224rpx;[^}]*border:\s*2rpx solid #ff9800;[^}]*background:\s*transparent;[^}]*color:\s*#ff9800;[^}]*font-weight:\s*600;/s);
});
